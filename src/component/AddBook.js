...
function AddBook({setEditMode,editMode}) {
      ...
      <div className="p-4 overflow-hidden bg-white shadow-cardShadow rounded-md">
        ...
        <form className="book-form" onSubmit={submitHandler}>
          ...
          <div className="flex items-center">
            <input id="input-Bookfeatured" type="checkbox" name="featured" className="w-4 h-4"value ={featured} onChange={(e) =>setFeatured(e.target.value)} />
